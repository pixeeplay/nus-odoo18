...
Answer in {language}.""",
    ...
    enrichment_paused = fields.Boolean(
        string='Pipeline en pause',
        default=False,
        help="Mettre en pause toutes les collectes et enrichissements automatiques.")
    searxng_parallel_workers = fields.Integer(
        string='SearXNG Parallel Workers',
        default=4,
        help="Number of parallel threads for SearXNG web searches. "
             "Higher = faster but more load on SearXNG instance.")
    ollama_parallel_workers = fields.Integer(
        string='Ollama Parallel Workers',
        default=2,
